...
#define RX_FIFO_SIZE			 128 // 36 									// 35 - minimum working
#define TX_EP0_FIFO_SIZE		64 // 16 									// 16 - minimum working
#define TX_EP1_FIFO_SIZE		128 // 320-(RX_FIFO_SIZE+TX_EP0_FIFO_SIZE)
